            ...
            {activeTab === 'about' && (
              ...
              >
                <div className="flex flex-col items-center text-center mb-12">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-2 md:mb-3">
                    Ashish Kumar Nanda
                  </h1>
              ...
              <pre className="m-0 bg-transparent p-0 text-left whitespace-pre">
                <code dangerouslySetInnerHTML={{
                  __html: displayedContent
                    // Basic syntax highlighting replacement hack
                    .replace(/const|let|var|function|return|import|export/g, '<span class="text-[#c586c0]">$&</span>')
                    .replace(/"[^"]*"/g, '<span class="text-[#ce9178]">$&</span>')
                    .replace(/'[^']*'/g, '<span class="text-[#ce9178]">$&</span>')
                    .replace(/true|false|null|undefined/g, '<span class="text-[#569cd6]">$&</span>')
                    // Wrap remaining JSON keys
...
const BrowserContent = () => {
  ...
  const tabs = [
    { id: 'overview', title: 'Start Page', url: 'portfolio.ashish-nanda.dev' },
              ...
              {activeTab === 'overview' ? (
                <div className="max-w-4xl mx-auto space-y-8">
                  <div className="text-center pt-8 pb-4">
                    ...
                    <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500">Ashish's Start Page</h1>
                  </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      {tabs.filter(t => t.id !== 'overview').map((project) => (
                        <div
                          ...
                          className="bg-gray-50 dark:bg-[#2c2c2e] border border-gray-200 dark:border-white/5 rounded-xl p-5 cursor-pointer hover:border-blue-500 hover:shadow-[0_4px_20px_rgba(59,130,246,0.15)] transition-all duration-300 group relative overflow-hidden"
                        >
                ...
                <div className="max-w-3xl mx-auto py-12 text-center h-full flex flex-col items-center justify-center">
                  ...
                  >
                    ...
                    <div className="p-8 text-left prose dark:prose-invert max-w-none">
                      <h1 className="text-3xl font-bold mb-4">{tabs.find(t => t.id === activeTab)?.title}</h1>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed mix-blend-plus-lighter">
                ...
                <AnimatePresence>
                  {photos.map((p, index) => (
                    <motion.div
                      ...
                      key={index}
                      className="aspect-square bg-gray-800 rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-blue-500 transition-all shadow-md group relative"
